...
$(document).ready(function() {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        WebAPI = 'http://117.120.7.120/spwebapi/api/resellerinfo';

    } else {

        WebAPI = 'http://117.120.7.120/spwebapi/api/resellerinfo?ResellerID=' + getSessionstorageValueUserResellerID;
    }
