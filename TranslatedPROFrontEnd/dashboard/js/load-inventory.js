...
$(document).ready(function () {
    ...
    $("#submit-filter").click(function () {
        ...
        var WebAPI = 'http://117.120.7.120/spwebapi/api/inventoryinfo?ResellerID=' + getReseller + '&CompanyID=' + getCompany;
...
$(document).ready(function () {
    ...
    if (getSessionstorageValueRoleID == 1) {
       ...
       WebAPI = 'http://117.120.7.120/spwebapi/api/inventoryinfo?CompanyID=' + '1';

    } else if (getSessionstorageValueRoleID == 2) {

        WebAPI = 'http://117.120.7.120/spwebapi/api/inventoryinfo?CompanyID=' + getSessionstorageValueCompanyID;
    } else if (getSessionstorageValueRoleID >= 3) {
        ...
        $('#inventory-editable').bootstrapTable({
            ...
            onCheck: function (row) {
                ...
                $("#itemImage").show();
                 ...
                 var itemRemarks = $('#itemRemarks').val(row.Remarks);
