...
$(document).ready(function () {
	...
	var acAPI = 'http://117.120.7.120/spwebapi/api/acinfo'
	
	var markup = "<div style='border-style: none; margin: 0px; padding: 0px 3px; overflow: auto' class=''>"
					+ "<table id='dailyScheduledTable' class='table table-bordered' cellspacing='0' width='100%'>"
					+ "<thead>"
					+ "<tr>"
					+ "<th style='color: gray; background-color: white; font-size: 8px'>AREA</th>"
	...
	$.ajax({
			...
			//console.log(data.length)
				for(var i = 0; i < data.length; i++){
					markup += "<th style='color: gray; background-color: white; font-size: 8px'>" + data[i].GeneralLocation + "</th>"
				...
				markup += "<td style='color: gray; background-color: white; font-size: 8px'>"
							+ "HELL</td>"
							+ "HE<td>"
							+ "</td>"
							+ "<td>"
	...
	if (markup !== undefined || markup !== null) $('#job-table').html(markup);
