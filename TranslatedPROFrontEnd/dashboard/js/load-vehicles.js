...
$(function () {
    ...
    $('.SelectFormCompanyFilter').on('change', function () {
        ...
        if (selectedCompany != 0) {
            ...
            if (getSessionstorageValueRoleID == 1) {
                WebAPIDriver = 'http://117.120.7.120/spwebapi/api/driverinfo?ResellerID=' + getReseller + '&CompanyID=' + selectedCompany;
            }

            else if (getSessionstorageValueRoleID == 2) {
                WebAPIDriver = 'http://117.120.7.120/spwebapi/api/driverinfo?ResellerID=' + getSessionstorageValueUserResellerID;
            ...
            if (getSessionstorageValueRoleID == 1) {
                getZone = 'http://117.120.7.120/spwebapi/api/zoneinfo?ResellerID=' + getReseller + '&CompanyID=' + selectedCompany;
                ...
                getZone = 'http://117.120.7.120/spwebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID;
                ...
                getZone = 'http://117.120.7.120/spwebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
            ...
            if (getSessionstorageValueRoleID == 1 || getSessionstorageValueRoleID == 2) {
                ...
                $.getJSON("http://117.120.7.120/spwebapi/api/devicetaginfo?ResellerID=" + getReseller + "&CompanyID=" + selectedCompany, function (data) {
                    $.each(data, function (index, item) {
...
$(document).ready(function () {
    ...
    $("#submit-filter").click(function () {
        ...
        if (getSessionstorageValueRoleID == 1) {
         ...
         WebAPI = 'http://117.120.7.120/spwebapi/api/assetinfo?UserID=' + '&ResellerID=' + getReseller + '&CompanyID=' + getCompany;
        
        } else {

         WebAPI = 'http://117.120.7.120/spwebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getReseller + '&CompanyID=' + getCompany;
...
var getZone = "";
    ...
    if (getSessionstorageValueRoleID == 1)
    {
        getZone = 'http://117.120.7.120/spwebapi/api/zoneinfo?ResellerID=' + '1' + '&CompanyID=' + '1';
    ...
    {
        $.getJSON("http://117.120.7.120/spwebapi/api/deviceinfo", function (data) {
            $.each(data, function (index, item) {
                var AssignedTags = item.AssetID;
    ...
    else if (getSessionstorageValueTrackVersion == "vn" || getSessionstorageValueTrackVersion == "th" || getSessionstorageValueTrackVersion == "id")
    {
        if (getSessionstorageValueRoleID == 1)
        {
            $.getJSON("http://117.120.7.120/spwebapi/api/devicetaginfo?ResellerID=" + "1" + "&CompanyID=" + "1", function (data) {
                $.each(data, function (index, item) {
                    var AssignedTags = item.AssetID;
            ...
            $.getJSON("http://117.120.7.120/spwebapi/api/devicetaginfo?ResellerID=" + getSessionstorageValueUserResellerID + "&CompanyID=" + getSessionstorageValueCompanyID, function (data) {
                $.each(data, function (index, item) {
                    var AssignedTags = item.AssetID;
