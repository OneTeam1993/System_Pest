...
//        WebAPI = 'http://117.120.7.120/spwebapi/api/assetinfo?UserID=' + '&ResellerID=' + '1' + '&CompanyID=' + '1';
//    }
//    else if (getSessionstorageValueRoleID == 2) {

//        WebAPI = 'http://117.120.7.120/spwebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
//    }
//    else if (getSessionstorageValueRoleID >= 3) {
...
$(function () {
    ...
    $('.SelectCompanyFilter').on('change', function () {
        ...
        if (selectedCompany > 0) {
            ...
            if (getSessionstorageValueRoleID == 1) {
                $.getJSON("http://117.120.7.120/spwebapi/api/companyinfo?&ResellerID=" + getReseller, function (data) {
            ...
            if (getSessionstorageValueRoleID == 1) {
                var getZoneAPI = 'http://117.120.7.120/spwebapi/api/zoneinfo?ResellerID=' + getReseller + '&CompanyID=' + selectedCompany;
            }

            else if (getSessionstorageValueRoleID == 2) {
                var getZoneAPI = 'http://117.120.7.120/spwebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID + "&CompanyID=" + selectedCompany;
            }

            else if (getSessionstorageValueRoleID >= 3) {
                var getZoneAPI = 'http://117.120.7.120/spwebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
            }
    ...
    $('.MobileSelectCompanyFilter').on('change', function () {
        ...
        if (selectedMobileCompany != 0) {
            ...
            if (getSessionstorageValueRoleID == 1) {
                ...
                if (selectedReseller != "") {
                    WebAPICompanyFilter = 'http://117.120.7.120/spwebapi/api/assetinfo?UserID=' + '&ResellerID=' + selectedReseller + '&CompanyID=' + selectedMobileCompany;
                } else {
                    WebAPICompanyFilter = 'http://117.120.7.120/spwebapi/api/assetinfo?UserID=' + '&ResellerID=' + getSessionstorageValueAssetReseller + '&CompanyID=' + selectedMobileCompany;
                }

            }
            else if (getSessionstorageValueRoleID == 2) {

                WebAPICompanyFilter = 'http://117.120.7.120/spwebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + selectedMobileCompany;
            }
            else if (getSessionstorageValueRoleID >= 3) {

                WebAPICompanyFilter = 'http://117.120.7.120/spwebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID;
            }
            ...
            $.getJSON("http://117.120.7.120/spwebapi/api/zoneinfo?CompanyID=" + selectedMobileCompany, function (data) {
    ...
    $('.MobileSelectVechsFilter').on('change', function () {
        ...
        if (selectedMobileAsset != 0) {
            ...
            if (getSessionstorageValueRoleID == 1) {
                ...
                if (selectedReseller != "") {
                    WebAPICompanyFilter = 'http://117.120.7.120/spwebapi/api/assetinfo?UserID=' + '&ResellerID=' + getReseller + '&CompanyID=' + getCompany + '&Assets=' + selectedMobileAsset;
                } else {
                    WebAPICompanyFilter = 'http://117.120.7.120/spwebapi/api/assetinfo?UserID=' + '&ResellerID=' + getSessionstorageValueAssetReseller + '&CompanyID=' + getCompany + '&Assets=' + selectedMobileAsset;
                }

            }
            else if (getSessionstorageValueRoleID == 2) {

                WebAPICompanyFilter = 'http://117.120.7.120/spwebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getCompany + '&Assets=' + selectedMobileAsset;
            }
            else if (getSessionstorageValueRoleID >= 3) {

                WebAPICompanyFilter = 'http://117.120.7.120/spwebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID + '&Assets=' + selectedMobileAsset;
            }
            ...
            $.getJSON("http://117.120.7.120/spwebapi/api/zoneinfo?CompanyID=" + getCompany, function (data) {
...
function setMarkers(map, assets, callback) {
    ...
    if (getSessionstorageValueRoleID == 1) {
        if (sessionStorage.getItem('setSessionstorageValueDefaultReseller') > 0 && sessionStorage.getItem('setSessionstorageValueDefaultCompany') > 0) {
            url = 'http://117.120.7.120/spwebapi/api/assetinfo?UserID=' + '&ResellerID=' + sessionStorage.getItem('setSessionstorageValueDefaultReseller') + '&CompanyID=' + sessionStorage.getItem('setSessionstorageValueDefaultCompany');
        } else {
            url = '';
        }
...
function setMarkersFilterMobile(map, assets, callback) {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        if (selectedMobileReseller != "") {
            url = 'http://117.120.7.120/spwebapi/api/assetinfo?UserID=' + '&ResellerID=' + selectedMobileReseller + '&CompanyID=' + selectedMobileCompany;
        } else {
            url = 'http://117.120.7.120/spwebapi/api/assetinfo?UserID=' + '&ResellerID=' + getSessionstorageValueAssetReseller + '&CompanyID=' + selectedMobileCompany;
        }

    } else if (getSessionstorageValueRoleID == 2) {

        url = 'http://117.120.7.120/spwebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + selectedMobileCompany;
...
function setMarkersFilterMobileAsset(map, assets, callback) {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        if (selectedMobileAsset != "") {
            url = 'http://117.120.7.120/spwebapi/api/assetinfo?UserID=' + '&ResellerID=' + getReseller + '&CompanyID=' + getCompany + '&Assets=' + selectedMobileAsset;
        } else {
            url = 'http://117.120.7.120/spwebapi/api/assetinfo?UserID=' + '&ResellerID=' + getSessionstorageValueAssetReseller + '&CompanyID=' + getCompany + '&Assets=' + selectedMobileAsset;
        }

    } else if (getSessionstorageValueRoleID == 2) {

        url = 'http://117.120.7.120/spwebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getCompany + '&Assets=' + selectedMobileAsset;

    } else if (getSessionstorageValueRoleID >= 3) {

        url = 'http://117.120.7.120/spwebapi/api/assetinfo?UserID=' + getSessionstorageValueUserID + '&ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getSessionstorageValueCompanyID + '&Assets=' + selectedMobileAsset;
...
function setInfoBubble(param) {
    ...
    var url = "http://117.120.7.120/spwebapi/api/jobinfo?AssetResellerID=" + getAssetReseller + "&AssetCompanyID=" + getAssetCompany + "&AssetID=" + param.id + "&Timestamp=" + getTimestamp + "&RxTime=" + getRxTime;
    var tabJobs;
...
function setZonesFilter(map, zones, callback) {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        if (selectedReseller != "") {
            url = 'http://117.120.7.120/spwebapi/api/zoneinfo?ResellerID=' + selectedReseller + '&CompanyID=' + selectedCompany;
        } else {
            url = 'http://117.120.7.120/spwebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueAssetReseller + '&CompanyID=' + selectedCompany;
        }

    } else if (getSessionstorageValueRoleID == 2) {

        url = 'http://117.120.7.120/spwebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + selectedCompany;
...
function setZonesFilterMobile(map, zones, callback) {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        if (selectedMobileReseller != "") {
            url = 'http://117.120.7.120/spwebapi/api/zoneinfo?ResellerID=' + selectedMobileReseller + '&CompanyID=' + selectedMobileCompany;
        } else {
            url = 'http://117.120.7.120/spwebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueAssetReseller + '&CompanyID=' + selectedMobileCompany;
        }

    } else if (getSessionstorageValueRoleID == 2) {

        url = 'http://117.120.7.120/spwebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + selectedMobileCompany;
...
function setZonesFilterMobileAsset(map, zones, callback) {
    ...
    if (getSessionstorageValueRoleID == 1) {
        ...
        if (selectedMobileReseller != "") {
            url = 'http://117.120.7.120/spwebapi/api/zoneinfo?ResellerID=' + getReseller + '&CompanyID=' + getCompany;
        } else {
            url = 'http://117.120.7.120/spwebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueAssetReseller + '&CompanyID=' + getCompany;
        }

    } else if (getSessionstorageValueRoleID == 2) {

        url = 'http://117.120.7.120/spwebapi/api/zoneinfo?ResellerID=' + getSessionstorageValueUserResellerID + '&CompanyID=' + getCompany;
