...
if (getSessionstorageValueCompanyID == 1) {
    groupApi = 'http://117.120.7.120/spwebapi/api/groupinfo';
}
else if (getSessionstorageValueCompanyID == 2) {
    groupApi = 'http://117.120.7.120/spwebapi/api/groupmyinfo';
}
...
$(function () {
    ...
    $('.SelectCompanyFilter').on('change', function () {
        ...
        $.getJSON("http://117.120.7.120/spwebapi/api/assetinfo?UserID=" + "&ResellerID=" + userReseller + "&CompanyID=" + selectedCompany, function (data) {
    ...
    $('.MobileSelectCompanyFilter').on('change', function () {
        ...
        $.getJSON("http://117.120.7.120/spwebapi/api/companyinfo?ResellerID=" + getMobileReseller, function (data) {
...
$(function () {
    ...
    $('.SelectJobResellerFilter').on('change', function () {
        ...
        $('#jobCompany').empty();
        $('#jobCompany').selectpicker('refresh');
        $.getJSON("http://117.120.7.120/spwebapi/api/companyinfo?&ResellerID=" + selectedJobReseller, function (data) {
    ...
    $('.SelectJobCompanyFilter').on('change', function () {
        ...
        $.getJSON("http://117.120.7.120/spwebapi/api/assetinfo?UserID=" + "&ResellerID=" + jobReseller + "&CompanyID=" + selectedJobCompany, function (data) {
...
$(document).ready(function () {
    ...
    if (getSessionstorageValueRoleID == 1) {
        jobApi = 'http://117.120.7.120/spwebapi/api/jobinfo?AssetResellerID=' + "1" + '&AssetCompanyID=' + "1" + '&AssetID=' + "" + '&Timestamp=' + getTimestamp + '&RxTime=' + getRxTime;
    }
    else if (getSessionstorageValueRoleID == 2) {
        jobApi = 'http://117.120.7.120/spwebapi/api/jobinfo?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + "" + '&AssetID=' + "" + '&Timestamp=' + getTimestamp + '&RxTime=' + getRxTime;
    }
    else if (getSessionstorageValueRoleID >= 3) {
        jobApi = 'http://117.120.7.120/spwebapi/api/jobinfo?AssetResellerID=' + '&AssetCompanyID=' + getSessionstorageValueCompanyID + '&AssetID=' + getAssets + '&Timestamp=' + getTimestamp + '&RxTime=' + getRxTime;
    }
...
function GenerateEN() {
        ...
        var jobApi = 'http://117.120.7.120/spwebapi/api/jobinfo?AssetResellerID=' + getReseller + '&AssetCompanyID=' + getCompany+ '&AssetID=' + getAsset + '&Timestamp=' + timestamp + '&RxTime=' + rxtime;
...
function GenerateAreaTable(){
    ...
    if (getSessionstorageValueCompanyID == 1) {
        ...
        acAPI = 'http://117.120.7.120/spwebapi/api/acinfo?Groups=' + $('#load-groups').val();
    
    }
	else if (getSessionstorageValueCompanyID == 2) {

        acAPI = 'http://117.120.7.120/spwebapi/api/acmyinfo?Groups=' + $('#load-groups').val();
        ...
        $.ajax({
            ...
            success: function (data) { 
                ...
                for(var i = 0; i < data.length; i++){
                    markup += "<th style='color: gray; background-color: white; font-size: 14px;padding-left: 10px;padding: 10px;'>" + data[i].Groups + "</th>"
                                    ...
                                    for(var k = 0; k < jobs.length; k++){
                                        ...
                                        if(k + 1 == jobs.length){
                                            if(hasJob){
                                                ...
                                                markup += "<td style='color: gray; background-color: white; font-size: 10px;padding: 5px;white-space: nowrap;'>" 
                                                    + jobInformation 
                                                    + "</td>"
                            ...
                            success: function (jobs) {
                                ...
                                if(jobs.length <= 0){
                                    ...
                                    for(var k = 0; k < jobs.length; k++){
                                        ...
                                        if(k + 1 == jobs.length){
                                            if(hasJob){
                                                markup += "<td style='color: gray; background-color: white; font-size: 10px;padding: 5px; white-space: nowrap;'>" + jobInformation + "</td>"
                                                //console.log("Job : True at " + jobInformation);
                                            }else{
                                                markup += "<td style='color: gray; background-color: white; font-size: 10px'></td>"
                                                //console.log("Job : False");
                            ...
                            success: function (jobs) {
                                ...
                                if(jobs.length <= 0){
                                    ...
                                    for(var k = 0; k < jobs.length; k++){
                                        ...
                                        if(getGroup == jobs[k].AcInfo.Groups){
                                            if(timeTableFormatter(jobs[k].Timestamp) > '0559' && timeTableFormatter(jobs[k].Timestamp) < '0800')
                                            {
                                                
                                                if(jobs[k].AcInfo.GeneralLocation == data[j].GeneralLocation){
                                                    jobInformation += "Time : " + timeTableFormatter(jobs[k].Timestamp) 
                                                                    + "<br>"
                                                                    + "Customer Company : " + jobs[k].Company 
                                                                    + "<br>"
                                        ...
                                        if(k + 1 == jobs.length){
                                            if(hasJob){
                                                ...
                                                markup += "<td style='color: gray; background-color: white; font-size: 10px;padding: 5px;'>" 
                                                    + jobInformation 
                                                    + "</td>"
                                                //console.log("Job : True at " + jobInformation);
                                            }else{
...
function changeDriver(jobid) {
    ...
    var WebAPIJob = '';
    WebAPIJobs = 'http://117.120.7.120/spwebapi/api/jobinfo/' + jobid;
    ...
    if (getSessionstorageValueCompanyID == 2) {
        ...
        success: function (data) { 
            ...
            for(var i = 0; i < data.length; i ++){
                ...
                var WebAPIJobs = 'http://117.120.7.120/spwebapi/api/jobinfo?AssetResellerID=' + getSessionstorageValueUserResellerID + '&AssetCompanyID=' + getSessionstorageValueCompanyID + '&Timestamp=' + timestamp + '&RxTime=' + rxtime + '&DriverID=' + data[i].DriverID;
...
$(document).ready(function () {
    ...
    if (getSessionstorageValueUser == null | getSessionstorageValueUser == undefined | getSessionstorageValueUser == "") {
        ...
        localStorage.clear();
        window.location.href = 'http://117.120.7.120/royal/'; //Login URL
